...
enum{
	YBUS_TOOL_NONE=0,
	YBUS_TOOL_SET_LANG=1,
	YBUS_TOOL_GET_LANG=2,
	YBUS_TOOL_SET_WM=3,
	YBUS_TOOL_TRIGGER=4,
	YBUS_TOOL_CONFIG=5,
	YBUS_TOOL_WM_FOCUS=6,
	YBUS_TOOL_RELOAD_ALL=7,
	YBUS_TOOL_KEYBOARD=8,
	YBUS_TOOL_EXIT=9,
	YBUS_TOOL_STATUS_POS=10,
	YBUS_TOOL_IMKEY=11,
	YBUS_TOOL_GET_INDEX=12,
	YBUS_TOOL_SET_WATCH=13,
};
